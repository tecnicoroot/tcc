...
class Cadastro extends Component {
  ...
  async componentDidMount() {
    ...
    if (id) {
      ...
      this.setState({ camara: data });
    }
  }

  salvar = async (camara) => {
     console.log(camara)
      await api.post("register", camara);
    ...
    return (
      <Row>
          ...
          <CardHeader>
                <FormGroup row>
                  ...
                  <Col xl="12" >
                    ...
                    <h2><span>Cadastro de Câmara</span> </h2>
                    </FormGroup>
                  </Col>
                  </Col>
        ...
        <Modal isOpen={this.state.modalRemover} toggle={this.fecharModalRemover}
            ...
            <ModalBody>
            Tem certeza que deseja excluir este camara? {this.state.camara.razaoSocial }`?
            </ModalBody>
            <ModalFooter>
