...
class Editar extends Component {
  ...
  salvar = async (empresa) => {
    ...
    await api.put(`register/${id}`, empresa);
    ...
    return (
      <Row>
                            ...
                            <FormGroup check inline>
                              <Input
                                ...
                                onChange={(e) => {
                                  ...
                                  setFieldValue("razao_social", "", true);
                                  setFieldValue("nome_fantasia", "", false);
                                }}
                              />
        ...
        <Modal isOpen={this.state.modalRemover} toggle={this.fecharModalRemover}
          ...
          <ModalBody>
            Tem certeza que deseja excluir este usuário? {this.state.empresa.email}`?
            </ModalBody>
          <ModalFooter>
